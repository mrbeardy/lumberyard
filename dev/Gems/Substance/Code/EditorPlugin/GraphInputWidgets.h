...
public:
    ...
    inline IGraphInput* GetGraphInput() const
    {
        return m_Input;
    }
...
private:
    ...
    void UpdateColor(const AZ::Color& color);
};
...
public:
    GIString(IGraphInput* pInput, QProceduralMaterialEditorMainWindow* pMainWindow);

    //from GIGraphInputHandler
    virtual void SyncUndoValue() override;
...
/**/
class GISliderIntBase
    : public TGISliderBase<int, AzQtComponents::SpinBox, AzQtComponents::SliderInt>
{
    Q_OBJECT
...
/**/
class GISliderFloatBase
    : public TGISliderBase<double, AzQtComponents::DoubleSpinBox, AzQtComponents::SliderDouble>
{
    Q_OBJECT
...
#define REGISTER_GIVECTOR_TYPE(name, t, dim, slider)                                   \
    class name                                                                         \
        : public TGIVectorBase<t, dim, slider>                                         \
    {                                                                                  \
        Q_OBJECT                                                                       \
    public:                                                                            \
