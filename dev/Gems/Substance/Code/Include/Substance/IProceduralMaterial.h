...
public:
    ...
    GraphValueVariant(const GraphValueVariant& cpy)
    {
        memcpy(this, &cpy, sizeof(GraphValueVariant));
    }
    GraphValueVariant(int vx, int vy = 0, int vz = 0, int vw = 0)
    {
        nValue[0] = vx;
        nValue[1] = vy;
        nValue[2] = vz;
    ...
    GraphValueVariant(float vx, float vy = 0.0f, float vz = 0.0f, float vw = 0.0f)
    {
        fValue[0] = vx;
        fValue[1] = vy;
        fValue[2] = vz;
    ...
    GraphValueVariant(double cdValue)
    {
        clear();
        fValue[0] = (float)cdValue;
    }
    GraphValueVariant(const char* szValue)
    {
        clear();
        stringValue = szValue;
    }
    GraphValueVariant(const Vec2i& vec)
    {
        clear();
        nValue[0] = vec.x;
        nValue[1] = vec.y;
    }
    GraphValueVariant(const Vec3i& vec)
    {
        clear();
        nValue[0] = vec.x;
        nValue[1] = vec.y;
    ...
    GraphValueVariant(const Vec4i& vec)
    {
        clear();
        nValue[0] = vec.x;
        nValue[1] = vec.y;
    ...
    GraphValueVariant(const Vec2& vec)
    {
        clear();
        fValue[0] = vec.x;
        fValue[1] = vec.y;
    }
    GraphValueVariant(const Vec3& vec)
    {
        clear();
        fValue[0] = vec.x;
        fValue[1] = vec.y;
    ...
    GraphValueVariant(const Vec4& vec)
    {
        clear();
        fValue[0] = vec.x;
        fValue[1] = vec.y;
    ...
    {
        return Vec2i(nValue[0], nValue[1]);
    }
    inline operator Vec3i() const
    {
        return Vec3i(nValue[0], nValue[1], nValue[2]);
    }
    inline operator Vec4i() const
    {
        return Vec4i(nValue[0], nValue[1], nValue[2], nValue[3]);
    }
    inline operator Vec2() const
    {
        return Vec2(fValue[0], fValue[1]);
    }
    inline operator Vec3() const
    {
        return Vec3(fValue[0], fValue[1], fValue[2]);
    }
    inline operator Vec4() const
    {
        return Vec4(fValue[0], fValue[1], fValue[2], fValue[3]);
    }
...
struct IGraphOutput
{
    ...
    virtual SubstanceAir::RenderResult* GetEditorPreview() const = 0;

    /// Get the associated output channel.
    virtual SubstanceAir::ChannelUse GetChannel() const = 0;
};
