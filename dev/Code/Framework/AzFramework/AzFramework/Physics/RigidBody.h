...
namespace Physics
{
    ...
    public:
        ...
        // LUMBERYARD_DEPRECATED(LY-114472) Use UpdateMassProperties instead.
        AZ_DEPRECATED(virtual void UpdateCenterOfMassAndInertia(bool computeCenterOfMass, const AZ::Vector3& centerOfMassOffset,
            bool computeInertia, const AZ::Matrix3x3& inertiaTensor) = 0, "Function deprecated, use UpdateMassProperties instead");
